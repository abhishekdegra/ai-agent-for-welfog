...
{{
  ...
  "natural_reply": "REQUIRED when detected_intent is NOT welfog_support: 1-3 warm sentences in the CUSTOMER's language/script. For harm_sensitive: empathetic, encourage safety and talking to someone they trust; mention India crisis lines iCall 9152987821 or Vandrevala 1860-2662-345 or emergency 112; NEVER mention grievance officer, legal compliance, seller registration, or product search. For general_chitchat: friendly Welfog support reply (greetings, thanks, bye, smalltalk) — warm ack THEN soft invite how you can help with Welfog shopping/orders/delivery/returns; not fake personal hangout history; no policy dump. For out_of_domain: acknowledge topic briefly, say you only help with Welfog shopping/orders/delivery/support, invite a Welfog question — do NOT answer off-topic facts (weather, cricket score, recipes, etc.). EMPTY string when welfog_support.",
